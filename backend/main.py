...
def analizar_plm(idx_or_id: str = Form(...)):
    """Ejecuta análisis PLM en una secuencia"""
    try:
...
def simular_laboratorio(idx_or_id: str = Form(...)):
    ...
    try:
        ...
        resultado = laboratorio.simular_experimento({"duracion": 10})
...
def simular_gemelo(idx_or_id: str = Form(...)):
    ...
    try:
        ...
        resultado = gemelo.simular_biorreactor(1, [0, 10], {"k": 0.1})
