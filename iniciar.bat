...
if exist "frontend" (
    ...
    echo.
    echo SOLUCION:
    echo 1. Verifica que hayas descargado TODAS las carpetas del proyecto
    echo 2. Ejecuta este script desde la carpeta raiz del proyecto
    echo 3. La estructura debe ser:
    echo    proyecto/
    echo    ├── backend/        ← Servidor FastAPI
    echo    ├── frontend/       ← Interfaz React
    echo    ├── modules/        ← Lógica PLM
    echo    ├── database/       ← Configuración DB
